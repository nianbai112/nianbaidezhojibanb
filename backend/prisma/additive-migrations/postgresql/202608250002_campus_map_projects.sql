...
CREATE UNIQUE INDEX IF NOT EXISTS "campus_map_projects_officialNumber_key"
  ON "campus_map_projects"("officialNumber");
CREATE INDEX IF NOT EXISTS "campus_map_projects_officialNumber_idx"
  ON "campus_map_projects"("officialNumber");
CREATE INDEX IF NOT EXISTS "campus_map_projects_constructionStatus_visibilityScope_idx"
