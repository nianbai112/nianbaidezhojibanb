-- CreateTable
CREATE TABLE "campus_map_collection_tasks" (
    "id" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE "campus_map_collection_assignments" (
    "id" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE "campus_map_marker_templates" (
    "id" TEXT NOT NULL,
    "regionId" TEXT,
    "label" TEXT NOT NULL,
    "description" TEXT,
...
-- CreateTable
CREATE TABLE "campus_map_collection_sessions" (
    "id" TEXT NOT NULL,
    "taskId" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE "campus_map_collection_points" (
    "id" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE "campus_map_collection_markers" (
    "id" TEXT NOT NULL,
    "sessionId" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE "campus_map_collection_marker_bindings" (
    "id" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE "campus_map_collection_attachments" (
    "id" TEXT NOT NULL,
    "sessionId" TEXT,
    "markerId" TEXT,
...
-- CreateIndex
CREATE INDEX "campus_map_collection_tasks_regionId_status_updatedAt_idx" ON "campus_map_collection_tasks"("regionId", "status", "updatedAt");

-- CreateIndex
CREATE INDEX "campus_map_collection_assignments_userId_createdAt_idx" ON "campus_map_collection_assignments"("userId", "createdAt");

-- CreateIndex
CREATE UNIQUE INDEX "campus_map_collection_assignments_taskId_userId_key" ON "campus_map_collection_assignments"("taskId", "userId");

-- CreateIndex
CREATE INDEX "campus_map_marker_templates_regionId_enabled_sortOrder_idx" ON "campus_map_marker_templates"("regionId", "enabled", "sortOrder");

-- CreateIndex
CREATE UNIQUE INDEX "campus_map_collection_sessions_clientSessionId_key" ON "campus_map_collection_sessions"("clientSessionId");

-- CreateIndex
CREATE INDEX "campus_map_collection_sessions_taskId_status_startedAt_idx" ON "campus_map_collection_sessions"("taskId", "status", "startedAt");

-- CreateIndex
CREATE INDEX "campus_map_collection_sessions_collectorUserId_startedAt_idx" ON "campus_map_collection_sessions"("collectorUserId", "startedAt");

-- CreateIndex
CREATE INDEX "campus_map_collection_points_sessionId_recordedAt_idx" ON "campus_map_collection_points"("sessionId", "recordedAt");

-- CreateIndex
CREATE UNIQUE INDEX "campus_map_collection_points_sessionId_clientPointId_key" ON "campus_map_collection_points"("sessionId", "clientPointId");

-- CreateIndex
CREATE UNIQUE INDEX "campus_map_collection_points_sessionId_batchNo_pointSeq_key" ON "campus_map_collection_points"("sessionId", "batchNo", "pointSeq");

-- CreateIndex
CREATE INDEX "campus_map_collection_markers_templateId_reviewStatus_idx" ON "campus_map_collection_markers"("templateId", "reviewStatus");

-- CreateIndex
CREATE INDEX "campus_map_collection_markers_sessionId_recordedAt_idx" ON "campus_map_collection_markers"("sessionId", "recordedAt");

-- CreateIndex
CREATE UNIQUE INDEX "campus_map_collection_markers_sessionId_clientMarkerId_key" ON "campus_map_collection_markers"("sessionId", "clientMarkerId");

-- CreateIndex
CREATE INDEX "campus_map_collection_marker_bindings_targetType_targetId_s_idx" ON "campus_map_collection_marker_bindings"("targetType", "targetId", "state");

-- CreateIndex
CREATE UNIQUE INDEX "campus_map_collection_marker_bindings_markerId_targetType_t_key" ON "campus_map_collection_marker_bindings"("markerId", "targetType", "targetId", "relationType");

-- CreateIndex
CREATE INDEX "campus_map_collection_attachments_sessionId_uploadedAt_idx" ON "campus_map_collection_attachments"("sessionId", "uploadedAt");

-- CreateIndex
CREATE INDEX "campus_map_collection_attachments_markerId_uploadedAt_idx" ON "campus_map_collection_attachments"("markerId", "uploadedAt");

-- CreateIndex
CREATE INDEX "campus_map_collection_attachments_checksum_idx" ON "campus_map_collection_attachments"("checksum");
