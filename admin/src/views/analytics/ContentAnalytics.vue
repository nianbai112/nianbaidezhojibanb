  ...
  <div class="page-container">
    ...
    <div class="stats-grid">
      <div class="stat-card glass-card">
        <div class="stat-value">{{ data.posts?.total || 0 }}</div>
        <div class="stat-label">总帖子</div>
      </div>
      <div class="stat-card glass-card">
        <div class="stat-value">{{ data.posts?.new || 0 }}</div>
        <div class="stat-label">新增帖子</div>
      </div>
      <div class="stat-card glass-card">
        <div class="stat-value">{{ data.comments?.total || 0 }}</div>
        <div class="stat-label">总评论</div>
      </div>
      <div class="stat-card glass-card">
        <div class="stat-value">{{ data.likes?.total || 0 }}</div>
...
.trend-bar { width: 100%; background: linear-gradient(180deg, #e6a23c, #f0c78a); border-radius: 4px 4px 0 0; transition: height 0.3s; }
